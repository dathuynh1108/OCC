...
from Git. backup_manifest.json lists the required local archive; backup_verified.json
is written only after every checksum passes. Runtime/lifecycle status is recorded in execution_closure.json.
